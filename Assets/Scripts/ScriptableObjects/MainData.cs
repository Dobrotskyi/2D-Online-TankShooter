...
public class MainData : PartData
{
    ...
    public MainData(string name, float acceleration, float maxSpeed, float angularSpeed, float durability, int ammo, Vector2 turretPos, Sprite sprite) : base(name, sprite)
    {
